...
namespace CobWeb.Server
{
    static class Program
    {
        ...
        static void Main()
        {
            try
            {
                ...
                HttpServer httpServer = new MyHttpServer(10086);
    ...
    public class IEVersion
    {
        ...
        /// </summary>
        public static void BrowserEmulationSet(int o = 0x2AF8)
        {
            using (var localKey = RegistryKey.OpenBaseKey(RegistryHive.LocalMachine, Environment.Is64BitOperatingSystem ? RegistryView.Registry64 : RegistryView.Registry32))
            {
                ...
                runKey.SetValue(Process.GetCurrentProcess().ProcessName + ".exe", o);
            }
    ...
    public class MyHttpServer : HttpServer
    {
        ...
        public override void handleGETRequest(HttpProcessor p)
        {
            ...
            var root = @"D:\Amayer\other code\vue2-elm-master\";
            var cob = root + h;
            var str = File.ReadAllText(root + h);
            p.outputStream.WriteLine(str);
            return;


            //HttpWebRequest req = (HttpWebRequest)HttpWebRequest.Create("http://cdn.ccode.com.cn/11Element%E5%AE%B9%E5%99%A8.html");
            //req.Method = "GET";

            //using (var response = (HttpWebResponse)req.GetResponse())
            //using (StreamReader reader = new StreamReader(response.GetResponseStream(), encoding: Encoding.UTF8))
            //{
            //    p.outputStream.WriteLine(reader.ReadToEnd());
            //}                
        }
